...
(async () => {
    ...
    await page.goto('https://store.nike.com/th/th_th/pd/%E0%B8%A3%E0%B8%AD%E0%B8%87%E0%B9%80%E0%B8%97%E0%B9%89%E0%B8%B2-air-max-97-on-air-gwang-shin/pid-12695658/pgid-12701528');
    ...
    // while(!finish){
        ...
        if(shoes.length > 0 && !found){
            ...
            try{ 
                ...
                const size = await page.$x(`//li[contains(text(), 'US M 8.5 / W 10')]`);
                await size[0].click();
            }
